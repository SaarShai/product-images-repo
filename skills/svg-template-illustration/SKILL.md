...
1. Read `AGENTS.md`.
2. For end-to-end SVG geometry plus reference-style adaptation, read
   `.codex/skills/svg-geometry-style-illustration/SKILL.md` first. This skill
   is the geometry-specialist delegate inside that larger workflow.
3. Read `docs/svg-template-illustration-workflow.md`.
4. Read `docs/review-judge-checklist.md`.
5. If previous candidates matched geometry but missed style, also read
...
6. If the task is Baci-door or hex-hole repair, also read

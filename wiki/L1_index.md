...
- concepts/geometry-adherence-needs-mechanical-enforcement-princess-n02 (fact tags=geometry,svg-template,evidentiary-run,cutouts,gates) -> `concepts/geometry-adherence-needs-mechanical-enforcement-princess-n02.md`
- concepts/staged-hardmask-pipeline-validated-experiment1 (fact tags=geometry,svg-template,controlnet,ip-adapter,composite-back,gates) -> `concepts/staged-hardmask-pipeline-validated-experiment1.md`

...
- `tasks/festive-v1-gingerbread-candidates/style-packet/reference-contact-sheet.png`
- `tasks/festive-v1-gingerbread-candidates/style-packet/style-exemplar-sheet.png`

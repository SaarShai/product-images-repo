...
Template 14:
Recreate the crop with careful architectural alignment: vertical stone courses on both piers, horizontal bridge deck, centered arch curve, matching turret roof angles, and waterline reflections aligned to the pier bases. Keep the original watercolor looseness.

...
Template 3:
Use the input image for layout only; create a natural final illustration of the bridge as if painted once by the original artist. Keep the left train, central arch opening, circular medallions, crenellated brick parapet, tree canopy, church steps, and reflective river in the same positions.

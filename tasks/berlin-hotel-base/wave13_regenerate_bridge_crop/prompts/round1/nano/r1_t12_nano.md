...
Template 12:
Produce a refined same-crop watercolor where the bridge architecture is well-composed but not mechanical: hand-drawn stone blocks, varied brick texture, small rail teeth along the parapet, turret shadows, and natural reflections under both piers.

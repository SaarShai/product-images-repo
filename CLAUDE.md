...
- **Transparent-background image work.** ANY task generating transparent-bg (RGBA)
  ...
  `skills/transparent-product-image-gen/SKILL.md` (validated Routes P + C-green v2)
  and `tasks/transparent-bg-endgame/REPORT.md` (evidence record). Canonical one-command
  pipeline: `/usr/bin/python3 scripts/run_c_green_v2.py`. Never ML-matting on fine art;
  never ship without gate_battery + 12× NEAREST junction review. (user-validated 2026-07-13)
